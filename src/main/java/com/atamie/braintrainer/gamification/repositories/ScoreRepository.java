package com.atamie.braintrainer.gamification.repositories;
 ...
 */
    /*@Query(value = "select sc.user_id, sum(sc.score) from score_card sc" +
            ...
            nativeQuery = true)*/
    @Query("SELECT NEW com.atamie.braintrainer.gamification.Domain.LeaderBoardRow(s.userId, SUM(s.score)) " +
            "FROM ScoreCard s " +
